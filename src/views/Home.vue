                          ...
                          <ul class="avatars-list mb-2">
                            <li>
                              <a href="#!" class="avatar avatar-sm">
                                <img alt="..." class="avatar-img rounded-circle" src="/static/assets/avatars/face-1.jpg">
                              </a>
                            </li>
                            <li>
                              <a href="#!" class="avatar avatar-sm">
                                <img alt="..." class="avatar-img rounded-circle" src="/static/assets/avatars/face-4.jpg">
                              </a>
                            </li>
                            <li>
                              <a href="#!" class="avatar avatar-sm">
                                <img alt="..." class="avatar-img rounded-circle" src="/static/assets/avatars/face-3.jpg">
                              </a>
                            </li>
                          </ul>
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-body text-center">
                      <a href="#!" class="avatar avatar-lg">
                        <img src="/static/assets/avatars/face-4.jpg" alt="..." class="avatar-img rounded-circle">
                      </a>
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto px-0">
                          <ul class="avatars-list m-0">
                            <li>
                              <a href="#!" class="avatar avatar-sm">
                                <img alt="..." class="avatar-img rounded-circle" src="/static/assets/avatars/face-2.jpg">
                              </a>
                            </li>
                            <li>
                              <a href="#!" class="avatar avatar-sm">
...
<script>
  export default {
    ...
    mounted() {
      this.show = true;
      console.log("Mounted")
      let src = "/static/js/apexcharts.custom.js";
